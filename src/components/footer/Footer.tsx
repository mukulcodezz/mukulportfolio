...
const socials = [
  ...
  { Icon: () => <Mail size={15} />, href: 'mailto:mukulwork1@gmail.com', label: 'Email' },
]
    ...
    <footer className="border-t border-line">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 pb-[max(2.5rem,env(safe-area-inset-bottom))] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-mono text-[11px] text-text-dim uppercase tracking-[0.14em]">
            © 2026 Mukul Gupta · AI / Automation Engineer
          </p>
        </div>
